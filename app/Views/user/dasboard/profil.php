        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary" style="font-size: 12px;">PROFIL CALON MAHASISWA</h6>
                </div>
                ...
                <div class="card-body">
                    ...
                    <h5 class="text-center text-gray-900 card-title mt-4 text-uppercase" style="font-size: 15px">
                        <b>No Pendaftaran : <?= $user['no_pendaftaran'] ?></b>
                    </h5>
                    <ul class="list-group">
                        ...
                        <li class="list-group-item ">
                            ...
                            <medium> <?= $user['tgl'] . ' | ' . $user['jam']; ?></medium>
                        </li>
