                        ...
                        <div class="col-md-12">
                            <div class="p-5">
                                <div class="text-center" class="text">
                                    ...
                                    <h3 class="h6 text-gray-900">Sistem Informasi Penerimaan Mahasiswa Baru (SiPMB)</h3>
                                    <h1 class="h5 text-gray-900"><b>STMIK Syaikh Zainuddin NW Anjani</b></h1>
                                    <div class="alert alert-primary">
                                        <h1 class="h6 text-gray-900"><b>PROGRAM STUDI</b></h1>
                                        <h4 class="h6 text-gray-900"><span class="badge badge-primary">S1 Teknik Informatika</span>|<span class="badge badge-warning">S1 Sistem Informasi</span></h4>
                                    </div>
                                ...
                                <hr>
                                <marquee>SELAMAT DATANG DI WEBSITE PMB ONLINE STMIK Syaikh Zainuddin NW Anjani | TAHUN AKADEMIK 2021/2022</marquee>
                            </div>
                        </div>
                    </div>
                </div>
