...
<body cz-shortcut-listen="true">
    ...
    <?php foreach ($pendaftar as $k) : ?>
        <table width="800" align="center" border="0" cellpadding="0" cellspacing="0" class="krs_box">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tl">TANGGAL & JAM UJIAN<br><em> </em></td>

                    <td class="tl">3 September 2020</td>
                </tr>
                <tr>

                    <td class="tl">PUNYA KIP/PKH/KKS?<br><em> </em></td>

                    <td class="tl">
                    <?php if($k['kip'] == 'Ya') : ?>
                 <?= $k['kip']; ?> |  Nomor : <?= $k['kode_kip']; ?>
                  <?php else : ?>
                  Bukan Penerima KIP/PKH/KKS
                  <?php endif; ?>
        ...
        <div>
            ...
            $userid = $k['no_pendaftaran'];
            $queryUser = $db->query("SELECT * FROM berkas WHERE no_pendaftaran=$userid");
