            ...
            <?php foreach ($pendaftar as $k) : ?>
                ...
                <div class="card-body">
                    ...
                    <h5 class="text-center text-gray-900 card-title mt-4 text-uppercase" style="font-size: 15px">
                        <b><?= $k['nama'] . " | No Pendaftaran : " . $k['no_pendaftaran'] ?></b><br>
                        <?php if($k['kip'] == 'Ya') : ?>
                 <span class="badge badge-primary">Punya KIP/PKH/KKS : <?= $k['kip']; ?> |  Nomor : <?= $k['kode_kip']; ?></span>
                  <?php else : ?>
                ...
                <?php else : ?>
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item ">
                                <h6 class="mb-0 text-gray-900" style="font-size: 13px"><b>Telepon/Hp Ortu</b></h6>
                                <medium><?= $telepon_ortu ?></medium>
                            </li>
